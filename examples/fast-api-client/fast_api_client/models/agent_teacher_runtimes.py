...
T = TypeVar("T", bound="AgentTeacherRuntimes")


@_attrs_define
class AgentTeacherRuntimes:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        agent_teacher_runtimes.additional_properties = additional_properties
        return agent_teacher_runtimes
