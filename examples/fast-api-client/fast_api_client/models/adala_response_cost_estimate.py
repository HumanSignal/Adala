...
T = TypeVar("T", bound="AdalaResponseCostEstimate")


@_attrs_define
class AdalaResponseCostEstimate:
    """
    Attributes:
        data (CostEstimate):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        data = CostEstimate.from_dict(d.pop("data"))
        ...
        adala_response_cost_estimate = cls(
            data=data,
            success=success,
            message=message,
            errors=errors,
        ...
        adala_response_cost_estimate.additional_properties = d
        return adala_response_cost_estimate
