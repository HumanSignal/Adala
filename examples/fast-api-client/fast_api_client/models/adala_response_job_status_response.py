...
T = TypeVar("T", bound="AdalaResponseJobStatusResponse")


@_attrs_define
class AdalaResponseJobStatusResponse:
    """
    Attributes:
        data (JobStatusResponse): Response model for getting the status of a job.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        data = JobStatusResponse.from_dict(d.pop("data"))
        ...
        adala_response_job_status_response = cls(
            data=data,
            success=success,
            message=message,
            errors=errors,
        ...
        adala_response_job_status_response.additional_properties = d
        return adala_response_job_status_response
