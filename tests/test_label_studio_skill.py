...
""",
    ...
    # Validate summary
    assert prediction['summary'] == 'Transaction Annotations', "Unexpected summary value"
    ...
    for i, expected_entry in enumerate(expected_sheet):
        ...
        assert actual_entry['index'] == expected_entry['index'], f"Sheet entry {i}: index mismatch"
        assert actual_entry['category'] == expected_entry['category'], f"Sheet entry {i}: category mismatch"
        assert actual_entry['groupNames'] == expected_entry['groupNames'], f"Sheet entry {i}: groupNames mismatch"
