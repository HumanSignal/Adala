...
2. Identify Keywords: Detect and note down the keywords within the text. Keywords are defined as words or phrases that carry significant meaning or relevance in relation to the context of the text and are directly associated with the LABELS specified above.
...
4. Assign Labels to Keywords: For each identified keyword, you must allocate an appropriate label from the LABELS listed above. Each label should closely match the context or category the keyword pertains to.
